function [Outputs,Pre_Labels]=MLKNN_test_small(train_data,train_target,test_data,Num,Prior,PriorN,Cond,CondN,ProTest,KeyCondLabel,KeyCondLabelN,NKeyCondLabel,NKeyCondLabelN)
...
%           train_target     - A M1xQ array, if the ith training instance belongs to the jth class, then train_target(j,i) equals +1, otherwise train_target(j,i) equals -1
%           test_data        - An M2xN array, the ith instance of testing instance is stored in test_data(i,:)
%           test_target      - A M2xQ array, if the ith testing instance belongs to the jth class, test_target(j,i) equals +1, otherwise test_target(j,i) equals -1
...
%Find neighbors of each testing instance
    Neighbors=cell(1,1); %Neighbors{i,1} stores the Num neighbors of the ith testing instance
